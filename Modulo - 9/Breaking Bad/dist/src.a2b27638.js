...
exports.showQuote = exports.createEpisodeRow = exports.showCharacter = exports.createCharacterRow = void 0;
...
var showQuote = function showQuote(quote) {
  var characterDetail = document.getElementById("character-detail");
...
var createEpisodeRow = function createEpisodeRow(episode) {
  var container = document.createElement("div"); //Se crea un DIv para almacenar la info del episodio

  var root = document.getElementById("episodes-list"); //recuperamos el contenedor de la lista de episodios

  root.appendChild(container); //y se hace hijo de este

  var ide = createEpisodeId(episode); //se llama  función que crea el span con el número del spisodio

  container.appendChild(ide); //y se hace hijo del contenedor de ese episodio

  var title = createEpisodeTitle(episode); //se llama  función que crea el span con el título del spisodio

  container.appendChild(title); //y se hace hijo del contenedor de ese episodio

  var season = createEpisodeSeason(episode); //se llama  función que crea el span con la temporada del spisodio
...
var createEpisodeId = function createEpisodeId(episode) {
  var epiId = document.createElement("span");
  epiId.innerHTML = episode.episode_id;
  return epiId;
}; //función para crear un span con el título del episodio, dicho span se devuelve al final


var createEpisodeTitle = function createEpisodeTitle(episode) {
...
var createEpisodeSeason = function createEpisodeSeason(episode) {
...
exports.getQuote = exports.getEpisodeList = exports.getCharacter = exports.getAllCharacters = void 0;
...
var getCharacter = function getCharacter(character) {
  var urlCharacter = "https://www.breakingbadapi.com/api/characters/" + character.char_id;
  return _axios.default.get(urlCharacter).then(function (response) {
    return response.data;
  }).then(function (character) {
    return character[0];
  }).catch(function (error) {
    return console.log("Se ha producido un error en caracter " + character.char_id);
  });
...
var getQuote = function getQuote(id) {
  var url = "https://www.breakingbadapi.com/api/quotes/" + id;
  return _axios.default.get(url).then(function (response) {
    return response.data[0].quote;
  }).catch(function (error) {
    return console.log("se ha producido un error en el quote");
  });
...
var getEpisodeList = function getEpisodeList() {
  return _axios.default.get("https://www.breakingbadapi.com/api/episodes").then(function (response) {
    return response.data;
  }).catch(function (error) {
    return console.log("se ha producido un error en la carga de episodios");
  });
}; //Funciones a exportar


exports.getEpisodeList = getEpisodeList;
},{"axios":"node_modules/axios/index.js","./utils":"src/utils.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
dataBusiness.getAllCharacters().then(function (data) {
  var characters = data;
  var nodes = [];
  ...
  try {
    var _loop = function _loop() {
      ...
      //recorremos el array con todos los personajes recuperados con axios
      var node = Utils.createCharacterRow(character); //se llama a la función que crea una fila con los datos del personaje que le pasamos como parámetro

      node.onclick = function () {
        //añadimos el evento on click para que al pulsar un personaje se muestre en detalle
        dataBusiness.getCharacter(character).then(function (character) {
          //se llama  la función que devuelve una promesa con los datos del personaje
...
dataBusiness.getEpisodeList().then(function (data) {
  //Se llama  a la función que devuelve la promesa con la lista de episodios
  var episodes = data;
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      //Se recorre el array de episodios
      if (episode.series === "Breaking Bad") {
        //Imprime solo los episodios de la serie breaking bad, no de la precuela better call Saoul
...
},{"./styles.css":"src/styles.css","./utils":"src/utils.js","./data-business":"src/data-business.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
