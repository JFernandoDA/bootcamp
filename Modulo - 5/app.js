...
function listarCarrito (){
    for (articulo of carrito){
        document.write ("<ul id='listado'>");
        document.write ("<li>"+articulo.name+"</li>");
        document.write ("</ul>");
    }
}
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
    ...
    function listarArticulo (item,n) {
       ...
       /* //lo primero se crea un cabecera mediante un parrafo en el DIV producto
        var otroArticulo = document.createElement ("p");
        var contenido  = document.createTextNode ( "---------Artículo Prime--------------");
        otroArticulo.appendChild(contenido);
        document.getElementById ("producto").appendChild (otroArticulo);*/
        ...
        var contenido  = document.createTextNode ( "---------Articículo "+n+"--------------");
