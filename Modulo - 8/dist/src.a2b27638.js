...
//Exportamos con ES6
//funciones usadas por: client-list-business.js y client-business.js
...
//Exportamos con ES6
//función usada por account-business.js
...
var UtilsAB = _interopRequireWildcard(require("./style-business"));
...
//Exportamos con ES6
//Función usada por client-business.js
...
var UtilsCB1 = _interopRequireWildcard(require("./data-business"));

var UtilsCB2 = _interopRequireWildcard(require("./account-business"));
...
function getClientElement(client) {
  var allAccounts = UtilsCB1.getAccounts();
  var clientAccounts = [];
  ...
  var ul = UtilsCB2.getClientAccountsElement(clientAccounts);
  node.appendChild(ul);
  return node;
}
...
//Exportamos con ES6
//función exportada usada por client-list-business.js
...
var UtilsCLB = _interopRequireWildcard(require("./data-business"));

var UtilsCLB2 = _interopRequireWildcard(require("./client-business"));
...
function printClientsAccounts() {
  var clients = UtilsCLB.getClients();
  var ul = document.createElement("ul");
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var element = UtilsCLB2.getClientElement(client);
...
},{"./client-list-business":"src/client-list-business.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
